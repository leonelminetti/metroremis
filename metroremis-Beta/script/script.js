...
function pausar() {
    ...
    if (!estaPausado) {
        ...
        document.getElementById('btnPause').innerHTML = `<p class="textoboton">Seguir</p>`;
        estaPausado = true;
    } else {
        ...
        intervalo = setInterval(registrarPunto, tiempo);
        intervaloCronometroViaje = setInterval(actualizarCronometroViaje, 1000);
        document.getElementById('btnPause').innerHTML = `<p class="textoboton">Pausar</p>`;
        estaPausado = false;
    }
}
...
function volverAConfig() {
    ...
    <p class="textoboton">Finalizar</p>`;
    document.getElementById('mainPage').classList.remove('active');
    document.getElementById('configPage').classList.add('active');
}
